...
void ThirWindow::displayImage()
{
   QString imagePath = "/Users/kleameta/Downloads/bmcc logo.png"; // Replace with the actual image file path
   ...
   // Scale the pixmap to fit the QLabel size (optional)
   ui->imageLabel->setScaledContents(true);
}
